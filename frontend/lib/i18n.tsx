...
const DICT: Record<string, Entry> = {
  ...
  "word.meaningsHint": {
    en: "Tick what the card should test — one meaning, several or all.",
    ru: "Отметьте, что проверять на карточке: одно значение, несколько или все.",
    zh: "勾选卡片要考的义项：一个、几个或全部。",
  },
  "word.meaningsTested": { en: "tested on the card", ru: "проверяется на карточке", zh: "卡片考这个" },
