...
const DICT: Record<string, Entry> = {
  ...
  "tutor.placeholderPhoto": { en: "Ask, or add a photo…", ru: "Спроси или добавь фото…", zh: "提问，或添加图片……" },
  "tutor.suggestPhoto": { en: "Photo of a page", ru: "Фото страницы", zh: "拍一页" },
  "tutor.attach": { en: "Add a photo", ru: "Добавить фото", zh: "添加图片" },
  "tutor.attachLimit": { en: "Up to {n} photos per message.", ru: "Не больше {n} фото в одном сообщении.", zh: "每条消息最多 {n} 张图片。" },
  "tutor.attachFailed": { en: "Couldn't open that image.", ru: "Не получилось открыть картинку.", zh: "无法打开这张图片。" },
  "tutor.removePhoto": { en: "Remove photo", ru: "Убрать фото", zh: "移除图片" },
  "tutor.openPhoto": { en: "Open photo", ru: "Открыть фото", zh: "查看图片" },
  "tutor.dropHere": { en: "Drop the photo here", ru: "Отпусти фото здесь", zh: "把图片拖到这里" },
  "tutor.photoChat": { en: "Photo", ru: "Фото", zh: "图片" },
  "tutor.mic": { en: "Say it", ru: "Сказать голосом", zh: "语音输入" },
  "tutor.stop": { en: "Stop", ru: "Остановить", zh: "停止" },
  "tutor.copy": { en: "Copy", ru: "Копировать", zh: "复制" },
  "tutor.copied": { en: "Copied", ru: "Скопировано", zh: "已复制" },
  "tutor.regenerate": { en: "Answer again", ru: "Ответить заново", zh: "重新回答" },
  "tutor.retry": { en: "Try again", ru: "Повторить", zh: "重试" },
  "tutor.edit": { en: "Edit and resend", ru: "Изменить и отправить заново", zh: "编辑后重发" },
  ...
  "mika.p.photo.title": { en: "A photo of a page", ru: "Фото страницы", zh: "拍一页课本" },
  "mika.p.photo.desc": {
    en: "A textbook page, a sign, a menu, a screenshot — Mika reads it, explains it and offers the words as cards.",
    ru: "Страница учебника, вывеска, меню, скриншот — Мика прочитает, объяснит и предложит слова карточками.",
    zh: "课本、招牌、菜单、截图——米卡读出来、讲清楚，并把生词做成卡片。",
  },
  ...
  "reader.pasteRead": { en: "Paste & read", ru: "Вставить и читать", zh: "粘贴并阅读" },
  "paste.label": { en: "Paste", ru: "Вставить", zh: "粘贴" },
  "paste.empty": { en: "The clipboard is empty", ru: "Буфер обмена пуст", zh: "剪贴板是空的" },
  "paste.denied": {
    en: "Couldn't read the clipboard — long-press the field and paste",
    ru: "Нет доступа к буферу — зажмите поле и выберите «Вставить»",
    zh: "无法读取剪贴板——长按输入框再粘贴",
  },
  ...
  "reader.tapHint": {
    en: "Tap unknown words to select them. Words you're learning are dashed, words you know are faded.",
    ru: "Нажимай на незнакомые слова, чтобы выбрать их. Те, что учишь, подчёркнуты пунктиром, знакомые — бледнее.",
    zh: "点选不认识的词。正在学的词带虚线，已掌握的词颜色较浅。",
  },
  ...
  "reader.scan": { en: "Photo or screenshot", ru: "Фото или скриншот", zh: "照片或截图" },
  ...
  "reader.knowPct": { en: "You know {n}%", ru: "Вы знаете {n}%", zh: "你认识 {n}%" },
  "reader.knownPctShort": { en: "{n}% known", ru: "знаю {n}%", zh: "认识 {n}%" },
  "reader.knownPctHint": {
    en: "Share of this text's words you know, repeats included. Known = a card past its learning steps.",
    ru: "Доля слов текста, которые вы знаете, с повторами. Знаю = карточка прошла этап изучения.",
    zh: "这篇文章中你认识的词所占比例（重复出现也计入）。认识 = 卡片已过学习阶段。",
  },
  "reader.newForTarget": { en: "{n} of them for HSK {level}", ru: "из них для HSK {level}: {n}", zh: "其中 {n} 个属于 HSK {level}" },
  "reader.legendLearning": { en: "learning", ru: "учу", zh: "学习中" },
  "reader.legendKnown": { en: "known", ru: "знаю", zh: "已掌握" },
  "reader.rubyOver": { en: "Pinyin over which words", ru: "Над какими словами транскрипция", zh: "给哪些词注音" },
  "reader.rubyUnknown": { en: "Unknown", ru: "Незнакомые", zh: "生词" },
  "reader.rubyAllWords": { en: "All", ru: "Все", zh: "全部" },
  ...
  "login.waitingHint": { en: "Tap “It's me” in the bot, then come back here — this page signs you in by itself.", ru: "Нажми «Это я» в боте и вернись сюда — страница войдёт сама.", zh: "在机器人里点“是我”，再回到这里——页面会自动登录。" },
  "login.noTelegramApp": { en: "No Telegram app on this phone? Open it on the web", ru: "Нет приложения Telegram? Открыть в браузере", zh: "手机上没有 Telegram？在网页中打开" },
  ...
  "coach.themePlaceholder": {
    ...
    zh: "你为什么学？如：雅思、出国工作、旅行",
  },
  "coach.themePlaceholderZh": {
    en: "Why are you learning Chinese? e.g. HSK 4 in May, business trips, dramas",
    ru: "Зачем учишь китайский? напр. HSK 4 в мае, командировки, дорамы",
    zh: "你为什么学中文？如：五月考 HSK 4、出差、看剧",
  },
  "coach.morePicks": { en: "{n} more, a goal or a topic", ru: "Ещё {n}, цель или тема", zh: "还有 {n} 个，目标或主题" },
  "coach.setGoal": { en: "Aim them at a goal or topic", ru: "Под цель или тему", zh: "按目标或主题挑选" },
  "coach.picksHintTopic": {
    en: "“{topic}” words for your level ({level}) and your goal.",
    ru: "Слова на тему «{topic}» под твой уровень ({level}) и цель.",
    zh: "适合你水平（{level}）和目标的「{topic}」主题词。",
  },
  "coach.topicLabel": { en: "Topic", ru: "Тема", zh: "主题" },
  "coach.topicSuggest": { en: "IT, Work, Travel, Food", ru: "IT, Работа, Путешествия, Еда", zh: "IT, 工作, 旅行, 美食" },
  "coach.topicOwn": { en: "Your own", ru: "Своя", zh: "自定" },
  "coach.topicPlaceholder": { en: "e.g. IT, medicine, dramas", ru: "напр. IT, медицина, дорамы", zh: "如：IT、医学、看剧" },
  "coach.topicGo": { en: "Pick", ru: "Подобрать", zh: "挑选" },
  "coach.topicClear": { en: "Clear the topic", ru: "Убрать тему", zh: "清除主题" },
  "coach.topicHint": {
    en: "A topic narrows the words on top of your goal — the goal stays.",
    ru: "Тема сужает подборку поверх цели — цель остаётся.",
    zh: "主题在目标之上缩小选词范围——目标不变。",
  },
  "coach.themeHint": {
  ...
  "today.sessionReady": { en: "cards ready · about {m} min", ru: "карточек ждёт · примерно {m} мин", zh: "张卡待复习 · 约 {m} 分钟" },
  "today.startReview": { en: "Start review", ru: "Начать повторение", zh: "开始复习" },
  "today.weakAfter": {
    en: "{n} words keep slipping — a short drill brings them back",
    ru: "{n} слов всё ускользают — короткая практика их закрепит",
    zh: "有 {n} 个词老是记不牢——做个小练习把它们拉回来",
  },
  "today.caughtUpDaily": {
    en: "Nothing to review right now. Today's new words are just below.",
    ru: "Сейчас повторять нечего. Слова на сегодня — чуть ниже.",
    zh: "现在没有要复习的。今日生词就在下面。",
  },
  "today.more": { en: "More on your progress", ru: "Подробнее о прогрессе", zh: "更多进度" },
  "today.moreSummary": { en: "{n} words · {m} mastered", ru: "слов: {n} · выучено: {m}", zh: "{n} 个词 · 已掌握 {m}" },
  ...
  "onb.eyebrow": { en: "Your HSK plan", ru: "Твой план HSK", zh: "你的 HSK 计划" },
  "onb.back": { en: "Back", ru: "Назад", zh: "返回" },
  "onb.continue": { en: "Continue", ru: "Дальше", zh: "继续" },
  "onb.skip": { en: "Skip", ru: "Пропустить", zh: "跳过" },
  "onb.langTitle": { en: "Which language should words be explained in?", ru: "На каком языке объяснять слова?", zh: "用哪种语言解释单词？" },
  "onb.langSub": { en: "Meanings, examples and the tutor will use it. You can change it later.", ru: "На нём будут значения, примеры и подсказки. Можно поменять потом.", zh: "释义、例句和辅导都会用它，之后可以更改。" },
  "onb.langOther": { en: "Another language", ru: "Другой язык", zh: "其他语言" },
  "onb.goalTitle": { en: "Why are you learning Chinese?", ru: "Зачем тебе китайский?", zh: "你为什么学中文？" },
  "onb.goalSub": { en: "Pick all that fit — Onomika picks words and examples for it.", ru: "Выбери всё, что подходит, — Onomika подберёт под это слова и примеры.", zh: "选出所有符合的——Onomika 会据此挑选单词和例句。" },
  "onb.goal.exam": { en: "Pass the HSK", ru: "Сдать HSK", zh: "通过 HSK 考试" },
  "onb.goal.study": { en: "Study in China", ru: "Учёба в Китае", zh: "去中国留学" },
  "onb.goal.work": { en: "Work and business", ru: "Работа и бизнес", zh: "工作和商务" },
  "onb.goal.travel": { en: "Travel", ru: "Путешествия", zh: "旅行" },
  "onb.goal.media": { en: "Dramas, music, games", ru: "Дорамы, музыка, игры", zh: "剧、音乐、游戏" },
  "onb.goal.people": { en: "Friends and family", ru: "Друзья и семья", zh: "朋友和家人" },
  "onb.goal.self": { en: "For myself", ru: "Для себя", zh: "为了自己" },
  "onb.levelTitle": { en: "How much Chinese do you know?", ru: "Как хорошо ты знаешь китайский?", zh: "你的中文水平如何？" },
  "onb.levelSub": { en: "A rough guess is fine — a one-minute check confirms it.", ru: "Можно примерно — минутная проверка уточнит.", zh: "大概就行——一分钟小测会确认。" },
  "onb.level.0": { en: "Starting from zero", ru: "С нуля", zh: "零基础" },
  "onb.level.0d": { en: "I know 你好 at most", ru: "Максимум 你好", zh: "最多会说“你好”" },
  "onb.level.1": { en: "I know some words", ru: "Знаю немного слов", zh: "认识一些词" },
  "onb.level.1d": { en: "Numbers, greetings, a few phrases — around HSK 1", ru: "Числа, приветствия, пара фраз — примерно HSK 1", zh: "数字、问候、几句话——大约 HSK 1" },
  "onb.level.2": { en: "Simple conversations", ru: "Простые разговоры", zh: "简单对话" },
  "onb.level.2d": { en: "Shopping, directions, about myself — HSK 2", ru: "Покупки, дорога, о себе — HSK 2", zh: "购物、问路、介绍自己——HSK 2" },
  "onb.level.3": { en: "Everyday topics", ru: "Бытовые темы", zh: "日常话题" },
  "onb.level.3d": { en: "Work, plans, feelings — HSK 3", ru: "Работа, планы, эмоции — HSK 3", zh: "工作、计划、感受——HSK 3" },
  "onb.level.4": { en: "Most topics, simple texts", ru: "Большинство тем, простые тексты", zh: "大多数话题、简单文章" },
  "onb.level.4d": { en: "Around HSK 4", ru: "Примерно HSK 4", zh: "大约 HSK 4" },
  "onb.level.5": { en: "News and books", ru: "Новости и книги", zh: "新闻和书籍" },
  "onb.level.5d": { en: "HSK 5 and up", ru: "HSK 5 и выше", zh: "HSK 5 及以上" },
  "onb.targetTitle": { en: "Which HSK level are you aiming for?", ru: "К какому уровню HSK идёшь?", zh: "你的目标是 HSK 几级？" },
  ...
  "onb.int.business": { en: "Business & money", ru: "Бизнес и финансы", zh: "商业与金融" },
  "onb.int.films": { en: "Films & dramas", ru: "Кино и дорамы", zh: "电影和电视剧" },
  "onb.int.music": { en: "Music", ru: "Музыка", zh: "音乐" },
  "onb.int.sport": { en: "Sport", ru: "Спорт", zh: "运动" },
  "onb.int.games": { en: "Games & anime", ru: "Игры и аниме", zh: "游戏和动漫" },
  "onb.int.science": { en: "Science", ru: "Наука", zh: "科学" },
  ...
  "onb.deckZero": { en: "Your first HSK {level} words", ru: "Твои первые слова HSK {level}", zh: "你的第一批 HSK {level} 单词" },
  "onb.buildTitle": { en: "Building your plan…", ru: "Составляем твой план…", zh: "正在生成你的计划…" },
  "onb.buildSub": { en: "From your answers and the words you just tapped.", ru: "По твоим ответам и словам, которые ты отметил.", zh: "根据你的回答和刚才点选的词。" },
  "onb.build.answers": { en: "Reading your answers", ru: "Смотрим твои ответы", zh: "分析你的回答" },
  "onb.build.level": { en: "Measuring your HSK {level}: you knew {known} of {shown}", ru: "Меряем твой HSK {level}: знаешь {known} из {shown}", zh: "评估你的 HSK {level}：{shown} 个里认识 {known} 个" },
  "onb.build.zero": { en: "Starting you at the beginning of the list", ru: "Начинаем с самого начала списка", zh: "从词表开头开始" },
  "onb.build.words": { en: "Choosing your first {n} HSK {level} words", ru: "Подбираем первые {n} слов HSK {level}", zh: "挑选你的前 {n} 个 HSK {level} 单词" },
  "onb.build.pace": { en: "Setting your pace: {n} new words a day", ru: "Ставим темп: {n} новых слов в день", zh: "设定节奏：每天 {n} 个新词" },
  "onb.readyTitle": { en: "Your plan is ready", ru: "Твой план готов", zh: "你的计划已就绪" },
  "onb.readyWords": { en: "Your first {n} words", ru: "Твои первые {n} слов", zh: "你的前 {n} 个单词" },
  "onb.readyCta": { en: "Sign in to start learning", ru: "Войти и начать учить", zh: "登录开始学习" },
  "onb.readyHint": { en: "Telegram, Google or email — the plan and these words come with you.", ru: "Telegram, Google или email — план и слова сохранятся.", zh: "Telegram、Google 或邮箱——计划和这些词都会保留。" },
  "onb.finishing": { en: "Setting up your words…", ru: "Готовим твои слова…", zh: "正在准备你的单词…" },
  "onb.finishingSub": { en: "Your plan and {n} words are moving onto your account.", ru: "Переносим план и {n} слов в твой аккаунт.", zh: "正在把计划和 {n} 个单词存入你的账号。" },
  "onb.prep.plan": { en: "Saving your plan", ru: "Сохраняем твой план", zh: "保存你的计划" },
  "onb.prep.cards": { en: "Making your {n} cards", ru: "Создаём карточки: {n}", zh: "制作你的 {n} 张卡片" },
  "onb.prep.meanings": { en: "Writing their meanings in {lang}", ru: "Пишем значения на языке: {lang}", zh: "用{lang}写释义" },
  "onb.prep.meaningsEn": { en: "Looking up their meanings", ru: "Ищем значения", zh: "查找释义" },
  "onb.welcomeTitle": { en: "Welcome to Onomika", ru: "Добро пожаловать в Onomika", zh: "欢迎来到 Onomika" },
  "onb.welcomeSub": { en: "Your {n} words are ready.", ru: "Твои слова готовы: {n}.", zh: "你的 {n} 个单词已准备好。" },
  "onb.welcomeContinue": { en: "Continue", ru: "Продолжить", zh: "继续" },
  "onb.finishSkip": { en: "Start without them", ru: "Начать без них", zh: "不带这些开始" },
  "onb.haveAccount": { en: "I have an account", ru: "У меня есть аккаунт", zh: "我有账号" },
  ...
  "hskList.cram": { en: "Cram my {n} cards", ru: "Зубрить мои карточки: {n}", zh: "突击我的 {n} 张卡" },
  ...
  "import.stop": { en: "Cancel", ru: "Отменить", zh: "取消" },
  "import.stoppedTitle": { en: "Adding cancelled", ru: "Добавление отменено", zh: "已取消添加" },
  "import.stopHint": {
    en: "Stop and remove this batch's cards (any you've already reviewed stay).",
    ru: "Остановить и убрать карточки этой партии (уже повторённые останутся).",
    zh: "停止并移除这批卡片（已复习过的会保留）。",
  },
  "import.removedN": { en: "{n} cards removed", ru: "Убрано карточек: {n}", zh: "已移除 {n} 张卡片" },
  "import.keptReviewed": { en: "{n} you'd already reviewed stay.", ru: "Уже повторённые остались: {n}.", zh: "已复习的 {n} 张保留。" },
  "import.trackRunning": { en: "Filling in your cards", ru: "Дополняем карточки", zh: "正在补全卡片" },
  "import.trackDone": { en: "Cards filled in", ru: "Карточки дополнены", zh: "卡片已补全" },
  "import.trackFailed": { en: "Filling in stopped on an error", ru: "Дополнение прервалось из-за ошибки", zh: "补全因出错中断" },
  "import.trackCards": { en: "{done} / {total} cards", ru: "{done} / {total} карточек", zh: "{done} / {total} 张卡片" },
  "import.trackCurrent": { en: "Now: {word}", ru: "Сейчас: {word}", zh: "当前：{word}" },
  "import.trackPreparing": { en: "Translating the meanings…", ru: "Переводим значения…", zh: "正在翻译释义…" },
  "import.trackOpenWord": { en: "Tap a word to open it", ru: "Нажмите на слово, чтобы открыть", zh: "点击单词即可打开" },
  ...
  "quiz.cram": { en: "Cram", ru: "Зубрёжка", zh: "突击复习" },
  "quiz.cramDesc": {
    en: "Every word in this list until you get each one right. Your review schedule doesn't move.",
    ru: "Все слова списка, пока каждое не будет верным. Расписание повторений не сдвигается.",
    zh: "把这个列表的每个词都练到答对为止。复习计划不会变。",
  },
  "quiz.cramStart": { en: "Cram {n} words →", ru: "Зубрить — слов: {n} →", zh: "突击 {n} 个词 →" },
  "quiz.cramEmpty": { en: "No words with a meaning in this list", ru: "В этом списке нет слов со значением", zh: "这个列表里没有带释义的词" },
  "quiz.cramDone": { en: "List crammed", ru: "Список пройден", zh: "列表练完了" },
  "quiz.cramScore": {
    en: "{n} words — wrong along the way: {m}.",
    ru: "Слов: {n}, ошибок по пути: {m}.",
    zh: "{n} 个词，途中错了 {m} 次。",
  },
  "quiz.cramUntouched": {
    en: "Your review schedule is exactly as it was.",
    ru: "Расписание повторений не изменилось.",
    zh: "复习计划完全没变。",
  },
  "quiz.cramAgain": { en: "Once more", ru: "Ещё раз", zh: "再来一遍" },
  ...
  "data.deleteHint": {
    ...
    ru: "Удаляет аккаунт и вместе с ним все карточки, повторения и заметки — через 14 дней после подтверждения. До этого можно войти и оставить аккаунт или удалить его сразу. Если данные могут пригодиться, сначала скачайте копию.",
    zh: "确认 14 天后删除你的账号，以及全部单词卡、复习记录和笔记。在此之前登录可以保留账号，也可以立即删除。如果以后可能需要，请先下载副本。",
  },
  "deleting.title": { en: "Your account will be deleted on {date}", ru: "Аккаунт будет удалён {date}", zh: "你的账号将于 {date} 删除" },
  "deleting.body": {
    en: "Everything is still here until then. Keep it, and it's as if nothing happened.",
    ru: "До этого дня всё на месте. Оставьте аккаунт — и всё будет как прежде.",
    zh: "在那之前一切都还在。保留账号，一切照旧。",
  },
  "deleting.keep": { en: "Keep my account", ru: "Оставить аккаунт", zh: "保留我的账号" },
  "deleting.keeping": { en: "Keeping…", ru: "Сохраняем…", zh: "正在保留…" },
  "deleting.now": { en: "Delete now instead", ru: "Удалить сразу", zh: "立即删除" },
  "deleting.nowTitle": { en: "Delete everything now?", ru: "Удалить всё сейчас?", zh: "现在就删除全部？" },
  "deleting.nowMessage": {
    en: "Your cards, reviews and texts are erased at once. This cannot be undone.",
    ru: "Карточки, повторения и тексты будут стёрты сразу. Отменить это нельзя.",
    zh: "你的单词卡、复习记录和文本将立即清除，无法撤销。",
  },
  "deleting.signOut": { en: "Sign out", ru: "Выйти", zh: "退出登录" },
  "deleting.download": { en: "Download my data", ru: "Скачать мои данные", zh: "下载我的数据" },
