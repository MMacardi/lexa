...
const DICT: Record<string, Entry> = {
  ...
  "reader.liveRead": { en: "Live read", ru: "Живое чтение", zh: "实时朗读" },
  "reader.liveHint": {
    en: "Read the text aloud — the words light up as we hear them, and you see the transcript live.",
    ru: "Читайте текст вслух — слова подсвечиваются по мере распознавания, а транскрипт виден сразу.",
    zh: "大声朗读课文——听到哪里就高亮到哪里，并实时显示识别文字。",
  },
  "reader.liveListening": { en: "Listening…", ru: "Слушаю…", zh: "聆听中…" },
  "reader.liveHeard": { en: "Heard", ru: "Услышано", zh: "已识别" },
  "reader.liveStop": { en: "Stop", ru: "Стоп", zh: "停止" },
  "reader.liveScore": { en: "Match · {pct}%", ru: "Совпадение · {pct}%", zh: "匹配度 · {pct}%" },
  "reader.liveEmpty": { en: "Nothing heard yet — start reading.", ru: "Пока ничего не распознано — начните читать.", zh: "尚未识别到内容——开始朗读吧。" },
  "reader.liveUnsupported": { en: "Live reading isn't available in this browser.", ru: "Живое чтение недоступно в этом браузере.", zh: "此浏览器不支持实时朗读。" },
