...
const DICT: Record<string, Entry> = {
  ...
  "onb.saveSignIn": { en: "Save my plan and sign in", ru: "Сохранить план и войти", zh: "保存计划并登录" },
  "onb.saveSignInHint": { en: "Telegram, Google or email — your answers come with you.", ru: "Telegram, Google или email — ответы сохранятся.", zh: "Telegram、Google 或邮箱——你的回答会保留。" },
  "onb.planSubGuest": { en: "Built from your answers. Sign in to keep it — then a one-minute check of what you already know.", ru: "Собран по твоим ответам. Войди, чтобы его сохранить, — потом минутная проверка того, что ты уже знаешь.", zh: "根据你的回答生成。登录即可保存——然后一分钟测一测你已经会的词。" },
